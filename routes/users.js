...
function userRoutes(app, controllers) {
    ...
    app.get('/users', verifyFBToken, ensureDatabaseReady, (req, res) => userController.getAllUsers(req, res));
    ...
    // Create new user
    app.post('/users', ensureDatabaseReady, (req, res) => userController.createUser(req, res));
