...
function repairRequestRoutes(app, controllers) {
    ...
    app.get('/repair-requests', verifyFBToken, ensureDatabaseReady, (req, res) => parcelController.getAllRepairRequests(req, res));

    // Get repair requests for technician
    app.get('/repair-requests/technician', verifyFBToken, ensureDatabaseReady, verifyTechnician, (req, res) => parcelController.getTechnicianRepairRequests(req, res));

    // Get repair request by ID
    app.get('/repair-requests/:id', verifyFBToken, ensureDatabaseReady, (req, res) => parcelController.getRepairRequestById(req, res));

    // Get repair status stats (admin only)
    app.get('/repair-requests/delivery-status/stats', verifyFBToken, ensureDatabaseReady, verifyAdmin, (req, res) => parcelController.getDeliveryStatusStats(req, res));
    ...
    app.get('/repair-requests/:id/eligible-technicians', verifyFBToken, ensureDatabaseReady, verifyAdmin, (req, res) => parcelController.getEligibleTechnicians(req, res));
    ...
    app.get('/admin/repair-requests', verifyFBToken, ensureDatabaseReady, verifyAdmin, (req, res) => parcelController.getAdminRepairRequests(req, res));
    ...
    // controller.
    app.post('/repair-requests', verifyFBToken, ensureDatabaseReady, verifyEmailVerified, (req, res) => parcelController.createRepairRequest(req, res));

    // Update repair request status
    app.patch('/repair-requests/:id/status', verifyFBToken, ensureDatabaseReady, (req, res) => parcelController.updateRepairRequestStatus(req, res));
    ...
    app.patch('/repair-requests/:id/cancel', verifyFBToken, ensureDatabaseReady, (req, res) => parcelController.cancelRepairRequest(req, res));
    ...
    // mutation).
    app.post('/repair-requests/:id/assignment/accept', verifyFBToken, ensureDatabaseReady, verifyTechnician, (req, res) => parcelController.acceptAssignment(req, res));
    app.post('/repair-requests/:id/assignment/reject', verifyFBToken, ensureDatabaseReady, verifyTechnician, (req, res) => parcelController.rejectAssignment(req, res));
    ...
    // projections.
    app.get('/repair-requests/:id/assignment', verifyFBToken, ensureDatabaseReady, (req, res) => parcelController.getAssignment(req, res));

    // Assign technician to repair request (admin only)
    app.patch('/repair-requests/:id', verifyFBToken, ensureDatabaseReady, verifyAdmin, (req, res) => parcelController.assignTechnicianToRepairRequest(req, res));
    ...
    app.delete('/repair-requests/:id', verifyFBToken, ensureDatabaseReady, (req, res) => parcelController.deleteRepairRequest(req, res));
}
